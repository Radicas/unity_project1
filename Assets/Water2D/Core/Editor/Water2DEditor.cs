        ...
        void OnSceneGUI()
        {
            ...
            if (WSpawner)
            {
               ...
               // EditorUtility.SetSelectedRenderState(WSpawner.GetComponent<MeshRenderer>(), EditorSelectedRenderState.Hidden);
                ...
                var fmh_1174_25_638577994359072697 = Quaternion.identity; newHandlePoint = (lTransform.position - Handles.FreeMoveHandle(
                ...
                var fmh_1213_91_638577994359102269 = Quaternion.identity; Vector3 newFreeHandlePoint = (Handles.FreeMoveHandle(lTransform.position,
